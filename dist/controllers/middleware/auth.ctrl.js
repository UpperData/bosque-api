                    ...
                    try {
                        ...
                        if (payload) {
                            if (payload.exp <= moment().unix()) {
                                ...
                                // permiso denegado con token valido                                
                                ...
                                //No emitido por pampatar posible intento de haker
                            ...
                            if (!isValid) {
                                // No autorizado ->posible intento de haker
                            ...
                            //No emitido por pampartar ->posible intento de haker
                            //res.redirect(process.env.HOST_FRONT+"expired/error");                           
