...
async function appointmentNew(req, res) {
    ...
    await model.patient.findAndCountAll({
        ...
        await model.appointment.create({ dateAppointment, hourAppointment, foreignId, siniestroId, address, isOpened, patientId, medialPersonal, appointmentTypeId }, { transaction: t }).then(async function (rsAppointment) {
            t.commit();
...
async function updateAppointment(req, res) {
    ...
    await model.patient.update({ //Actualiza datos del paciente      
        ...
        { dateAppointment, hourAppointment, foreignId, siniestroId, address, isOpened, patientId, medialPersonal, appointmentTypeId }, { where: { id, isOpened: true } }, { transaction: t }).then(async function (rsAppointment) {
