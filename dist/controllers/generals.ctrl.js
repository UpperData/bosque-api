...
async function getCivil(req, res) {
    ...
    if (id != '*') {
        ...
        return await model.civil.findAll({ attributes: ['id', 'name'],
...
async function getPhoneType(req, res) {
    ...
    if (id != '*') {
        ...
        //Busca todos estado civil
        return await model.phoneType.findAll({ attributes: ['id', 'name', 'icon'],
...
async function getDepartament(req, res) {
    ...
    if (id != '*') {
        ...
        return await model.departament.findAll({ attributes: ['id', 'name'],
...
async function getSubDepartament(req, res) {
    ...
    if (depId != '*') {
        ...
        //Busca todos Sub Deaprtament
        return await model.subDepartament.findAll({ attributes: ['id', 'name'],
            include: [{
...
async function getCargo(req, res) {
    ...
    if (depId != '*') {
        ...
        return await model.cargo.findAll({ attributes: ['id', 'name'],
            include: [{
                model: model.departament,
                attributes: [['id', 'departamentId'], 'name']
            }],
...
async function getPatienType(req, res) {
    ...
    if (id != '*') {
        ...
        //Busca todos Cargos de un departamento
        return await model.patientType.findAll({ attributes: ['id', 'name'],
...
async function getState(req, res) {
    ...
    if (id != '*') {
        ...
        return await model.state.findAll({ attributes: ['id', 'name'],
...
async function getCitiesByState(req, res) {
    ...
    if (stateId != '*') {
        ...
        //Busca todos de estados de Venezuela
        return await model.city.findAll({ attributes: ['id', 'name', 'isCapital'],
            include: [{
                model: model.state,
                attributes: ['id', 'name']
            }],
...
async function getProvincesByState(req, res) {
    ...
    if (stateId != '*') {
        ...
        //Busca todos de estados de Venezuela
        return await model.province.findAll({ attributes: ['id', 'name'],
            include: [{
                model: model.state,
                attributes: ['id', 'name']
            }],
...
async function getParroquiaByProvince(req, res) {
    ...
    if (provinceId != '*') {
        ...
        //Busca todos de estados de Venezuela
        return await model.parroquia.findAll({ attributes: ['id', 'name'],
            include: [{
                model: model.province,
                attributes: ['id', 'name']
            }],
...
async function getAppointmentTpye(req, res) {
    ...
    if (id != '*') {
        ...
        //Busca todos de estados de Venezuela
        return await model.appointmentType.findAll({ attributes: ['id', 'name', 'icon'],
...
async function getExams(req, res) {
    ...
    if (id != '*') {
        ...
        //Busca todos de estados de Venezuela
        return await model.exam.findAll({ attributes: ['id', 'name'],
...
async function getCarModels(req, res) {
    ...
    if (make == '*') {
        ...
        request("https://carapi.app/api/models?make=" + make, (err, response, body) => {
            if (!err) {
                const models = JSON.parse(body);
                res.status(200).json({ "data": { "result": true, "message": "Busqueda satisfatoria", "data": models.data } });
            }
